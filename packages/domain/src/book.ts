...
export const createBook = (input: CreateBookInput): CreateBookResult => {
  ...
  return {
    ...
    value: Object.freeze({
      ...
      ...(input.publisher !== undefined && { publisher: input.publisher.trim() }),
      ...(input.publicationYear !== undefined && { publicationYear: input.publicationYear }),
      ...(input.isbn !== undefined && { isbn: input.isbn.trim() }),
      ...(input.language !== undefined && { language: input.language.trim() }),
      ...(input.description !== undefined && { description: input.description.trim() }),
      ...(input.seriesId !== undefined && { seriesId: input.seriesId.trim() }),
