...
export const createBook = (input: CreateBookInput): CreateBookResult => {
  ...
  return {
    ...
    value: Object.freeze({
      ...
      pageCount: input.pageCount !== undefined ? { pageCount: input.pageCount } : {},
      addedAt: input.addedAt,
      publisher: input.publisher !== undefined ? { publisher: input.publisher.trim() } : {},
      publicationYear:
        input.publicationYear !== undefined ? { publicationYear: input.publicationYear } : {},
      isbn: input.isbn !== undefined ? { isbn: input.isbn.trim() } : {},
      language: input.language !== undefined ? { language: input.language.trim() } : {},
      description: input.description !== undefined ? { description: input.description.trim() } : {},
      seriesId: input.seriesId !== undefined ? { seriesId: input.seriesId.trim() } : {},
      seriesPosition:
